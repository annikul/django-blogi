...
DEBUG = (os.environ.get('DEBUG', '').lower() not in {'o', 'no', 'false'})
...
if DROPBOX_APP_KEY:
    ...
    # jotta niiden puuttuminen aiheuttaisi hyvin aikaisessa
    # vaiheessa virheen. Jos käytettäisiin .get():itä niin virhettä ei tulisi
    # vielä tässävaiheessa, vaan vasta silloin kun DropBoxia yritettäisiin käyttää.                                   
